...
vim.keymap.set("n", "<leader>d", ":Neotree<CR>", { silent = true })

-- highlights
-- vim.api.nvim_set_hl(0, "NeoTreeBufferNumber", { link = "" })
-- vim.api.nvim_set_hl(0, "NeoTreeCursorLine", { link = "" })
-- vim.api.nvim_set_hl(0, "NeoTreeDimText", { link = "" })
-- vim.api.nvim_set_hl(0, "NeoTreeDirectoryIcon ", { link = "" })
-- vim.api.nvim_set_hl(0, "NeoTreeDirectoryName ", { link = "" })
-- vim.api.nvim_set_hl(0, "NeoTreeDotfile", { link = "" })
-- vim.api.nvim_set_hl(0, "NeoTreeFileIcon", { link = "" })
-- vim.api.nvim_set_hl(0, "NeoTreeFileName", { link = "" })
-- vim.api.nvim_set_hl(0, "NeoTreeFileNameOpened", { link = "" })
-- vim.api.nvim_set_hl(0, "NeoTreeFilterTerm", { link = "" })
-- vim.api.nvim_set_hl(0, "NeoTreeFloatBorder", { link = "" })
-- vim.api.nvim_set_hl(0, "NeoTreeFloatTitle", { link = "" })

-- vim.api.nvim_set_hl(0, "NeoTreeTitleBar", { link = "" })

-- vim.api.nvim_set_hl(0, "NeoTreeGitAdded", { link = "" })
-- vim.api.nvim_set_hl(0, "NeoTreeGitConflict", { link = "" })
-- vim.api.nvim_set_hl(0, "NeoTreeGitDeleted", { link = "" })
-- vim.api.nvim_set_hl(0, "NeoTreeGitIgnored", { link = "" })
-- vim.api.nvim_set_hl(0, "NeoTreeGitModified", { link = "" })
-- vim.api.nvim_set_hl(0, "NeoTreeGitUnstaged", { link = "" })
-- vim.api.nvim_set_hl(0, "NeoTreeGitStaged", { link = "" })
-- vim.api.nvim_set_hl(0, "NeoTreeGitUntracked", { link = "" })
-- vim.api.nvim_set_hl(0, "NeoTreeHiddenByName", { link = "" })
-- vim.api.nvim_set_hl(0, "NeoTreeIgnored", { link = "" })

-- vim.api.nvim_set_hl(0, "NeoTreeIndentMarker", { link = "" })

-- vim.api.nvim_set_hl(0, "NeoTreeExpander", { link = "" })
-- vim.api.nvim_set_hl(0, "NeoTreeNormal", { link = "" })
-- vim.api.nvim_set_hl(0, "NeoTreeNormalNC", { link = "" })
-- vim.api.nvim_set_hl(0, "NeoTreeSignColumn", { link = "" })
-- vim.api.nvim_set_hl(0, "NeoTreeStats", { link = "" })
-- vim.api.nvim_set_hl(0, "NeoTreeStatsHeader", { link = "" })
-- vim.api.nvim_set_hl(0, "NeoTreeStatusLine", { link = "" })
-- vim.api.nvim_set_hl(0, "NeoTreeStatusLineNC", { link = "" })
-- vim.api.nvim_set_hl(0, "NeoTreeVertSplit", { link = "" })
-- vim.api.nvim_set_hl(0, "NeoTreeWinSeparator", { link = "" })
-- vim.api.nvim_set_hl(0, "NeoTreeEndOfBuffer", { link = "" })
-- vim.api.nvim_set_hl(0, "NeoTreeRootName", { link = "" })
-- vim.api.nvim_set_hl(0, "NeoTreeSymbolicLinkTarget", { link = "" })
-- vim.api.nvim_set_hl(0, "NeoTreeTitleBar", { link = "" })

-- vim.api.nvim_set_hl(0, "NeoTreeWindowsHidden ", { link = "" })
...
-- nvim tree plugin not working on windows - trying another now
...
--     },
--     trash = {
--         cmd = "C:/msys64/mingw64/bin/gio trash"
--     },
...
--             }
--         end
--         vim.keymap.set('n', 'cw',   api.fs.rename_sub,                   opts('Rename: Omit Filename'))
...
--         vim.keymap.set('n', 'yl',       api.fs.copy.relative_path,           opts('Copy Relative Path'))
...
--         vim.keymap.set('n', '<C-]>',       api.node.run.system,                 opts('Run System'))
-- 
--         vim.keymap.set('n', 'tt',       api.tree.expand_all,                 opts('Expand All'))
--         vim.keymap.set('n', 'T',       api.tree.collapse_all,               opts('Collapse'))
...
--         vim.keymap.set('n', 'tv',       api.tree.toggle_no_bookmark_filter,  opts('Toggle Filter: No Bookmark'))
...
--         vim.keymap.set('n', 't0',       api.live_filter.clear,               opts('Live Filter: Clear'))
--         vim.keymap.set('n', 't/',       api.live_filter.start,               opts('Live Filter: Start'))
-- 
--         vim.keymap.set('n', '<C-s>',       api.tree.reload,                     opts('Refresh'))
-- 
